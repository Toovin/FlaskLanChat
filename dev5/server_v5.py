...
from lc_config import UPLOAD_DIR, AVATAR_DIR, DEFAULT_AVATAR_DIR, EXTENSIONS_DIR, MEDIA_DOWNLOAD_DIR, THUMBNAILS_DIR, THUMBNAILS_MEDIA_DOWNLOADED_DIR, LIVEKIT_API_KEY, LIVEKIT_API_SECRET, LIVEKIT_WS_URL
...
if __name__ == '__main__':
    print("Starting HTTPS server on port 6970...")
    socketio.run(app,
                 host='0.0.0.0',
                 port=6970,
                 debug=True,
