...
UPLOAD_DIR = 'FlaskLanChat_Dev/dev5/static/uploads' # use absolute path here
THUMBNAILS_DIR = 'FlaskLanChat_Dev/dev5/static/thumbnails/uploads' # use absolute path here
